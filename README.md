...
"Distinct" counts are up to the full symmetry group of $Q_n$ (translation, axis permutation, and reversal, plus rotation, for coils). Dim-9's 131 is a believed-complete census; the other snake counts are distinct classes found so far (lower bounds).
